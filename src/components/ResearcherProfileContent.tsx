...
const ResearcherProfileContent: React.FC<ResearcherProfileContentProps> = ({ uid }) => {
  ...
  if (!researcher) {
    return <div className="flex items-center justify-center h-screen text-gray-500">No Researcher Found</div>;
  }
                    ...
                    openAlexData.works.map((work, index) => (
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-600 space-y-1 mb-4">
                          ...
                          <p>
                            <span className="font-medium text-gray-700">Type:</span> {work.type}
                          </p>
                        </div>
...
export default ResearcherProfileContent;